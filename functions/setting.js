function updateLinkAndPreview() {
    ...
    let pomodoro = document.getElementById("PomodoroTimer").value;
    ...
    let link = `https://harly-1506.github.io/${pomodoro}.html?focus=${focus}&break=${breakTime}&reps=${reps}&color=${encodeURIComponent(color)}&timerFont=${encodeURIComponent(timerFont)}&sessionFont=${encodeURIComponent(sessionFont)}&alignment=${alignment}`;
